        ...
        <div class="span8">
            ...
            <table class="pull-right">
                ...
                <tr class="toggle-elm">
                    <td class="right">
                    <label>{__("net_total")}
                        <input type="hidden" name="net_total" value="N" />
                        <input type="checkbox" class="valign cm-combinations" name="net_total" value="Y" id="sw_manual_net_total" /></label>
                    </td>
                    <td class="right">
                        <span data-ca-switch-id="manual_net_total">
                            {include file="common/price.tpl" value=$order_info.net_total}
                        </span>
                        <span style="display: none;" data-ca-switch-id="manual_net_total">
                            {include file="common/price.tpl" value=$order_info.net_total view="input" input_name="update_order[net_total]" input_val=$order_info.net_total class="input-small"}
                        </span>
                    </td>
                </tr>
                <tr>
